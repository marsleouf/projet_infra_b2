              ...
              value: function (t) {
                ...
                return (
                  ...
                  A.globals.dataChanged &&
                    P &&
                    T &&
                    C.animatePathsGradually(n({}, E, { speed: p })),
                  M
                );
              },
            },
            ...
            value: function (t, e) {
              ...
              if (this.annoCtx.invertAxis) {
                ...
                if (s.config.yaxis[e.yAxisIndex].logarithmic)
                  o =
                    (a = new m(this.annoCtx.ctx).getLogVal(a, e.yAxisIndex)) /
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              a.config.yaxis[t.yAxisIndex].logarithmic
                ? (o =
                    (l = new m(this.annoCtx.ctx).getLogVal(l, t.yAxisIndex)) /
              ...
              if (
                ...
                if (
                  (f.attr({ rel: i }), e.appendChild(f.node), t.customSVG.SVG)
                ) {
            ...
            value: function (t, e, i, a) {
              ...
              if (
                ...
                for (var d = 0; d < l.x.length; d++) {
                  ...
                  if (b || r) {
                    g.isNumber(l.y[d])
                      ? (x += " w".concat(g.randomId()))
                      : (x = "apexcharts-nullpoint");
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              a.dropShadow.enabled &&
                new u(this.ctx).dropShadow(l, a.dropShadow);
              return l;
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (c.enabled && !m) {
                ...
                var v = "";
                void 0 !== a &&
                  (v = x(a, { seriesIndex: s, dataPointIndex: r, w: d })),
          ...
          },
          {
            ...
            value: function (t) {
              return this.w.globals.dom.baseEl.querySelector(
                "[seriesName='".concat(g.escapeString(t), "']")
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              c.globals.previousPaths.length > 0 &&
                (x = this.barCtx.getPreviousPath(o, h, !1));
              var b = e,
                m = e + i;
              return {
                pathTo: (f =
              ...
              for (var o = 0, l = 0; o < t.length; o++, l++) {
                ...
                for (
                  ...
                  var P = this.barHelpers.getStrokeWidth(o, L, y),
                    T = null,
                    z = {
                      indexes: { i: o, j: L, realIndex: y, bc: l },
                      x: f,
                      y: x,
                      strokeWidth: P,
                      elSeries: w,
                  ...
                  this.isHorizontal
                    ? ((T = this.drawBarPaths(
                        n({}, z, { barHeight: k, zeroW: u, yDivision: c })
                      )),
                      (A = this.series[o][L] / this.invertedYRatio))
                    : ((T = this.drawColumnPaths(
                        n({}, z, { xDivision: h, barWidth: A, zeroH: d })
                      )),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              L.attr(
                ...
                void 0 !== g &&
                  void 0 !== f &&
                  (L.attr("data-range-y1", g), L.attr("data-range-y2", f)),
            ...
            value: function (t, e) {
              ...
              for (
                ...
                for (
                  ...
                  if (
                    ((u = v.yDivision), (b = v.barHeight), this.isHorizontal)
                  ) {
                    L = d + b * this.visibleI;
                ...
                void 0 !== t[e].data[n].y &&
                  (Array.isArray(t[e].data[n].y)
                    ? this.twoDSeries.push(
                        g.parseNumber(t[e].data[n].y[t[e].data[n].y.length - 1])
                      )
              ...
              l.push("category"),
                i.map(function (t, e) {
                  o.globals.axisCharts &&
                    l.push(t.name ? t.name : "series-".concat(e));
                }),
          ...
          },
          {
            ...
            value: function (t, e, i, a) {
              ...
              var h = o.map(function (t, a) {
                ...
                return (
                  Math.round(o / g.roundToBase(o, 10)) * g.roundToBase(o, 10)
                );
              });
              return (
                0 === h[0] && (h[0] = 1),
              ...
              if (t.config.xaxis.crosshairs.show) {
                ...
                1 === t.config.xaxis.crosshairs.width && (w = e.drawLine()),
                  w.attr({
                    ...
                    width: g.isNumber(t.config.xaxis.crosshairs.width)
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                1.05 *
                  (t = new p(this.dCtx.ctx).getTextRects(
                    a,
                    e.config.xaxis.labels.style.fontSize
                  )).width *
                  i.length >
            ...
            value: function (t) {
              this.ctx.getSyncedCharts().forEach(function (t) {
                ...
                var i = t.ctx.series.emptyCollapsedSeries(
                  g.clone(e.globals.initialSeries)
                );
              ...
              if (
                (e.shiftKey
                  ? ((this.shiftWasPressed = !0),
                    s.enableZoomPanFromToolbar("pan"))
                  : this.shiftWasPressed &&
                    (s.enableZoomPanFromToolbar("zoom"),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (f = a[i].children),
                ...
                h.blxaxisTooltip &&
                  (h.xaxisTooltipText.innerHTML = "" !== g ? g : d);
            ...
            value: function (t, e, i, a, s) {
              ...
              if (n.config.legend.tooltipHoverFormatter) {
                ...
                for (var g = 0; g < d.length; g++) {
                  ...
                  if (r)
                    u.innerHTML =
                      n.globals.collapsedSeriesIndices.indexOf(f) < 0 ? b : x;
                    ...
                    for (var A = 0; A < a.globals.dataPoints; A++) {
                      ...
                      i.isHorizontal
                        ? ((L = i.drawStackedBarPaths(
                            n({}, C, { zeroW: f, barHeight: y, yDivision: d })
                          )),
                          (w = i.series[s][A] / i.invertedYRatio))
                        : ((L = i.drawStackedColumnPaths(
                            n({}, C, { xDivision: c, barWidth: w, zeroH: u })
                          )),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              o.globals.isXNumeric &&
                (i =
                  (o.globals.seriesX[x][c] - o.globals.minX) / this.xRatio -
                  s / 2);
            ...
            value: function (t) {
              ...
              if (i.globals.dataChanged) {
                ...
                for (var f = 0; f < i.globals.previousPaths.length; f++)
                  (c =
                    (this.fullAngle * g.negToZero(i.globals.previousPaths[f])) /
                    d),
      ...
      function t(i) {
        ...
        (this.strokeWidth = a.config.stroke.show ? a.config.stroke.width : 0),
          ...
          a.config.xaxis.labels.show &&
            (this.size = this.size - r.width / 1.75),
              ...
              for (
                ...
                e.globals.dataChanged &&
                  ...
                  (C =
                    Math.round(
                      (this.totalAngle *
                        g.negToZero(e.globals.previousPaths[m])) /
                        100
                    ) + k)),
            ...
            value: function (t) {
              ...
              if (0 === n) {
                ...
                l.globals.isXNumeric &&
                  ...
                  h.push(d),
                  c.push(
                    g.isNumber(e[r][0]) ? o + l.config.markers.offsetY : null
                  ),
            ...
            value: function (t) {
              for (
                var e = t.series,
                  ...
                  A = l.pathFromLine,
                  S = l.pathFromArea,
                  C = g.isNumber(b.globals.minYArr[i])
                    ? b.globals.minYArr[i]
                    : b.globals.minY,
                  L =
                ...
                if (b.globals.isXNumeric) {
                  ...
                  void 0 === b.globals.seriesX[i][P + 1] &&
                    (z = b.globals.seriesX[i][L - 1]),
                    ...
                    u = this.prevSeriesY[
                      (function (t) {
                        for (var e = t, i = 0; i < b.globals.series.length; i++)
                          if (
                            b.globals.collapsedSeriesIndices.indexOf(t) > -1
                          ) {
                            e--;
                            break;
                          }
              ...
              if (
                ...
                null === e[i][s] && ((h += x.move(r, n)), (c += x.move(r, m))),
                  "stepline" === b
                    ...
                    : "straight" === b &&
                      ((h += x.line(r, n)), (c += x.line(r, n))),
                  s === e[i].length - 2 &&
                    ((c = c + x.line(r, m) + x.move(r, n) + "z"),
                    d.push(h),
                    g.push(c));
              }
              return {
            ...
            value: function () {
              ...
              if (
                ("%" === a
                  ? g.isNumber(i[0]) &&
                    (0 === i[0].width &&
                      (i = g.getDimensions(this.el.parentNode)),
          ...
          },
          {
            ...
            value: function () {
              ...
              p.setAttrs(t.dom.elGraphical.node, i),
                (t.x2SpaceAvailable =
                  t.svgWidth - t.dom.elGraphical.x() - t.gridWidth);
            },
          },
          {
                  ...
                  return (
                    ...
                    e &&
                      ...
                      n &&
                        ...
                        (o.globals.initialSeries = JSON.parse(
                          JSON.stringify(o.config.series)
                        )))),
                    r.update(e)
                  );
                });
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (
                ...
                s &&
                  ((r.globals.initialConfig.series = JSON.parse(
